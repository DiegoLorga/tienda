...
public class Interfaz_clientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Direccion de envio", "Cuanta de pago", "Cantidad comprada en el ultimo mes"
            }
        ));
    ...
    private void button3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button3ActionPerformed
       ...
       serviciosCliente.actualizarCliente(numero);
...
button1.addActionListener(new ActionListener() {
    ...
    String Cuenta = jTextField4.getText();
        ...
        serviciosCliente.crearCliente(Nombre, Direccion, Cuenta);
    jTextField2.setText("");
    jTextField3.setText("");
    jTextField4.setText("");
...
private ServiciosCliente serviciosCliente = new ServiciosCliente();

    private void actualizarTabla() {
    DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
    model.setRowCount(0); // Limpiar la tabla

    // Recorrer listaClientes y agregar cada cliente como una fila en la tabla
    for (Clientes cliente : serviciosCliente.getListaClientes()) {
        Object[] row = {
            cliente.getNumCliente(), // Suponiendo que cada cliente tiene un número de cliente único
            cliente.getNombre(),
            cliente.getDireccionEnvio(),
            cliente.getCuentaPago(),
            cliente.getVentaMes()
        };
        model.addRow(row);
    }
